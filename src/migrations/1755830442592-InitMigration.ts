...
export class InitMigration1755830442592 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "otps" ADD "created_by_user_id" uuid`);
    await queryRunner.query(
      `ALTER TABLE "otps" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "otps" ADD "last_modified_by_user_id" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "otps" ADD "deleted_at" TIMESTAMP WITH TIME ZONE`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "otps" DROP COLUMN "user_id"`);
    await queryRunner.query(
      `ALTER TABLE "otps" ADD "user_id" character varying NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "otps" DROP COLUMN "created_at"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "otps" DROP COLUMN "last_modified_by_user_id"`,
    );
    await queryRunner.query(`ALTER TABLE "otps" DROP COLUMN "updated_at"`);
    await queryRunner.query(
      `ALTER TABLE "otps" DROP COLUMN "created_by_user_id"`,
    );
    await queryRunner.query(`ALTER TABLE "otps" ADD "userId" uuid`);
    await queryRunner.query(
